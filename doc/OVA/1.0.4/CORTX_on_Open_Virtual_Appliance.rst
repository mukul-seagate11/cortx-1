...
#. Check the health of CORTX using `hctl <https://github.com/Seagate/cortx/blob/main/doc/checking_health.rst>`_ by running this command
   ...
   .. image:: https://github.com/TechWriter-Mayur/cortx/blob/R2-OVA-Branch/doc/images/104hctl_status_output.png
...
#. Run **ip a l** and record the IP addresses of the following interfaces:
   ...
   * ens34 - Private data IP (if present)
   ...
   .. image:: https://github.com/TechWriter-Mayur/cortx/blob/R2-OVA-Branch/doc/images/104networks.png
